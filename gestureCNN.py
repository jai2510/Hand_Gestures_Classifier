...
path2 = '/Users/jai/Asingh_CNN/imgfolder_b'
...
def loadCNN(bTraining = False):
    ...
    if not bTraining :
        ...
        WeightFileName = modlistdir('/Users/jai/Asingh_CNN')
        ...
        #w = int(input("Which weight file to load (enter the INDEX of it, which starts from 0): "))
            fname = "/Users/jai/Asingh_CNN/pretrained_weights_MacOS.hdf5"
        #print("loading ", fname)
            model.load_weights(fname)
            print('Found the weight file')
